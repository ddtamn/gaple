...
6. Permainan berakhir ketika:
   ...
   - **Semua pemain pass** berurutan ("Domi")
...
Pemain menghabiskan kartu terakhirnya

### 2. Ceki Palang — **4 poin** 🏆

Pemain menutup dengan **kartu balak** (kembar), dan kedua sisi dari kiri dan kanan sama, misalnya penutup balak 6|6, maka kartu kiri dan kanan di meja juga 6 - 6 Ini adalah kemenangan tertinggi.

### 3. Ceki — **3 poin**

Kartu terakhir yang dimainkan bisa dimasukkan di **kedua ujung** papan (kiri dan kanan). Artinya kartu tersebut memiliki nilai yang cocok dengan kedua ujung yang terbuka tetapi kalau balak itu akan di hiting "Ceki Palang" 4 poin
...
### 6. Cekik (Pass) — **1 poin per cekikan**

Setiap kali seorang pemain pass, pemain yang membuatnya pass (pemain sebelumnya) mendapat **1 poin tambahan**.

Setiap poin yg di dapat pada ronde pertama akan di akumulasi dengan ronde selanjutnya sampai ronde selesai
...
| ---------------- | ---- | ------------------------------------------------ |
| Domi             | 1    | Habis kartu, kartu biasa                         |
| Cekik            | 3    | Kartu bisa masuk kiri & kanan                    |
| Cekik Palang     | 4    | Kartu bisa masuk kiri & kanan dengan kartu balak |
| Gab              | 1    | Semua pass, pemenang pip terkecil                |
| Gab Tangkap      | 2    | Buntu, pemenang bukan yang terakhir main         |
| Pass             | +1   | Setiap kali lawan pass                           |
